const imagePaths = [
  ...
  {
    standartMob: './src/img/my-project-business@1x.jpg',
    retinaMob: './src/img/my-project-business@2x.jpg',
    standartTab: './src/img/my-project-business@1x.jpg',
    retinaTab: './src/img/my-project-business@2x.jpg',
    standartDesk: './src/img/my-project-business@1x.jpg',
    retinaDesk: './src/img/my-project-business@2x.jpg',
